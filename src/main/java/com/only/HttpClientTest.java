...
public class HttpClientTest {
    ...
    public void initClass(){
        String cookie="_device_session_id=p_6b8cd0bf-7af1-4114-a8ac-877e477dd0b31; _cp_dt=0a4d0c88-e293-4c3d-8c44-e37884b6bfd7-15356; _snsr=direct%7Cdirect%7C%7C%7C; __ssar=direct%7Cdirect%7C%7C%7C; _snmc=1; _snma=1%7C149913122949043714%7C1499131229490%7C1499677803670%7C1499682901151%7C39%7C18; _snmp=149968290106647859; _snmb=149968290116163430%7C1499682901164%7C1499682901161%7C1; __ssav=149913122949043714%7C1499131229684%7C1499677803837%7C1499682901514%7C39%7C15%7C0; __ssas=149968290152558042%7C1499682901529%7C1499682901525%7C1; authId=siDD032ADD29ADB477595A6A90FA40DB87; __snuotr=2EF9FCA0%5E0K2NIBCAI%7B338RCK1K4V%3DDH%2593B57; custLevel=161000000130; custno=6007868507; idsLoginUserIdLastTime=18651668461; logonStatus=2; nick=186******61; nick2=186******61; "
                + "sncnstr=pyEjUNw6GIkw9pHRf9TnlA%3D%3D; _snck=149968290533741956; __utma=64295096.1274220774.1499075641.1499657907.1499682906.27; __utmb=64295096.6.8.1499682913870; __utmc=64295096; __utmz=64295096.1499075641.1.1.utmcsr=(direct)|utmccn=(direct)|utmcmd=(none)";
        //1:创建一个httpclient对象
        HttpClient httpclient = new DefaultHttpClient();
        Charset charset = Charset.forName("UTF-8");//设置编码
        try {
            //2：创建http的发送方式对象，是GET还是post
            HttpPost httppost = new HttpPost("11.do");
